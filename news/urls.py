...
urlpatterns = [
    ...
    path('admin/contacts/', views.admin_contact_list, name='admin_contact_list'),
    path('admin/contacts/<int:message_id>/', views.admin_contact_detail, name='admin_contact_detail'),
    path('admin/contacts/<int:message_id>/delete/', views.admin_contact_delete, name='admin_contact_delete'),
    path('admin/contacts/<int:message_id>/mark-read/', views.admin_contact_mark_read, name='admin_contact_mark_read'),
] 